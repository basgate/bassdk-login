...
?>
	...
	public function login_form_add_external_service_links()
	{
		?>
		<script>
			console.log("STARTED login_form_add_external_service_links()")
		</script>
		<?php
		// Grab plugin settings.
		$options       = Options::get_instance();
	...
	?>
		<script>
			console.log("STARTED wp_login_errors__maybe_redirect_to_cas()")
		</script>
		<?php
	...
	public function maybe_add_external_wordpress_to_log_in_links($login_url)
	{
		...
		?>
		<script>
			console.log("STARTED maybe_add_external_wordpress_to_log_in_links() ")
		</script>
<?php
