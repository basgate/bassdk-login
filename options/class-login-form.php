...
class Login_Form extends Singleton
{
	...
	{
		wp_enqueue_style('bassdk-login-styles', plugins_url('css/styles.css', \BasgateSDK\plugin_root()), array(), '1.0');
		//TODO: Replace this script with cdn url
		wp_enqueue_script('bassdk-login-script', plugins_url('js/script.js', \BasgateSDK\plugin_root()), array('jquery'), '1.0', true);
